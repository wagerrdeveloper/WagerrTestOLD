...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_UPDATED_BETTING_PROTOCOL) r = SPORK_17_UPDATED_BETTING_PROTOCOL_DEFAULT;  //Patch Code
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_UPDATED_BETTING_PROTOCOL") return SPORK_17_UPDATED_BETTING_PROTOCOL;  //Patch Code
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_UPDATED_BETTING_PROTOCOL) return "SPORK_17_UPDATED_BETTING_PROTOCOL";  //Patch Code
